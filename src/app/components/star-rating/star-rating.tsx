...
const StackedStar = ({ size = 200, color , score } : StackedStarType) => {
  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      >
        ...
        />
        <defs>
          <linearGradient id={`paint0_linear_739_340_${size}`} x1="81.3041" y1="-19.4075" x2="100.748" y2="225.234" gradientUnits="userSpaceOnUse">
      ...
      >
        ...
        />
        <defs>
          <linearGradient id={`paint0_linear_739_341_${size}`} x1="117.272" y1="221.7" x2="94.3087" y2="-17.6562" gradientUnits="userSpaceOnUse">
            <stop stopColor={color}/>
      ...
      {score !== undefined && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <span className={`text-white font-primaryRegular`} style={{ fontSize: `${size * 0.25}px` }}>
            {score}
          </span>
        </div>
      )}
