...
export const MissionSection = () => {
  ...
  return (
    <div className="md:py-[124px] py-[8.281rem] relative w-full flex items-center justify-center">
      <div className="absolute z-0 lg:mt-10 mt-2 hidden md:flex md:flex-col overflow-hidden">
