...
export const HomeBanner = () => {
  return (
    <div className="grid bg-[url('/banner-bg.svg')] bg-no-repeat bg-cover w-full">
      <Header />
      <div className="grid items-center mt-[9.75rem] lg:mt-[17rem] justify-self-center w-full lg:w-11/12 pb-12 gap-y-12 lg:px-0 px-4">
        ...
        >
          <div className="flex gap-4 items-center justify-center flex-wrap">
            <div className="flex gap-1 lg:gap-3 border border-2 border-dashed border-green-green1 rounded-lg text-white items-center px-2 lg:px-4 py-2">
              <CircleCheckBig
                size={33}
                fill="#16974D"
                color="#224B9F"
            ...
            <div className="flex gap-1 lg:gap-3 border border-2 border-dashed border-blue-blue1 text-white rounded-lg items-center px-2 lg:px-4 py-2">
