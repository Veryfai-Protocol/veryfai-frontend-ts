          ...
          <div className="flex items-center">
            <Input
              ...
              className={`rounded-full transition-all duration-300 h-[66px] ${
                ...
                animateUp ? "translate-y-[-50px] opacity-0" : ""
              } py-4 pl-6 md:pr-[120px] w-full text-gray-700 focus:outline-none`}
            ...
            {inputValue.length > 0 && (
              <Button
                className={`absolute right-4 bg-[#1E90FF] text-white rounded-full flex items-center gap-2 md:h-[45px] md:w-[110px] w-12 h-12 justify-center hover:bg-blue-600 transition-all duration-300 ${
                  animateUp ? "translate-y-[-50px] opacity-0" : ""
                }`}
                onClick={handleCheck}
              >
